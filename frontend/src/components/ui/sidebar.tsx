...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/shipments", label: "Shipments", icon: PackageIcon },
    ...
    <aside className="flex h-full w-64 flex-col bg-[var(--sidebar-bg)] text-[var(--sidebar-text)]">
      ...
      <div className="flex h-16 items-center gap-2 px-6 border-b border-gray-700">
        <span className="text-xl font-bold text-white tracking-tight">
          Naql<span className="text-blue-400">.ai</span>
        </span>
        <span className="ml-auto rounded bg-blue-600/20 px-2 py-0.5 text-xs text-blue-400">
          Beta
        </span>
      </div>
