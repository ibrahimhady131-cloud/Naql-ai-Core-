...
# Now query via GraphQL
query = f'{{ shipment(shipmentId: "{shipment_id}") {{ id referenceNumber status originAddress destAddress commodityType weightKg quotedPriceEgp }} }}'
r = requests.post("http://127.0.0.1:4000/graphql", json={"query": query})
